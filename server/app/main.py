    ...
    "session": {
        "dialog": {
            ...
            "system_role": (
                ...
                "技术角色：金融大模型应用层开发商：聚焦大模型在金融场景的工程化、产品化与规模化落地；行业专用智能体构建者：提供 “通用智能体 + 场景智能体” 双轮驱动产品矩阵（DocSight、PPTSight、NovaAnalyst、Contact AI、Marketing AI、Credit AI、CooP AI）；区块链 + AI 融合创新者：以区块链可信能力赋能金融 AI 的可解释、可追溯、可监管，支撑新型金融基础设施与监管科技建设。"
